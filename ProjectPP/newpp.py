...
class Application(tk.Tk):
    def __init__(self):
        ...
        # creating a notebook for different tabs
        ...
        cancel_tab = ttk.Frame(notebook)
        notebook.add(cancel_tab, text="Cancel")

        # adding widgets to the "Book" tab
        book_label = ttk.Label(book_tab, text="Book Tickets")
        book_label.pack(pady=10)

        # add your booking-related widgets here

        # adding widgets to the "Booking Details" tab
        details_label = ttk.Label(details_tab, text="Booking Details")
        details_label.pack(pady=10)

        # add your booking details-related widgets here

        # adding widgets to the "Cancel" tab
        cancel_label = ttk.Label(cancel_tab, text="Cancel Booking")
        cancel_label.pack(pady=10)

        # add your cancellation-related widgets here

# functions and classes from the original code
